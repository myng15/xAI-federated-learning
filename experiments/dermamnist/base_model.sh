...
logs_dir="logs/dermamnist/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
chkpts_dir="chkpts/dermamnist/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
results_dir="results/dermamnist/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
