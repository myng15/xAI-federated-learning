...
rm -rf data/cifar10/all_clients_data

python data/cifar10/generate_data.py \
    --n_tasks 200 \
...
logs_dir="logs/cifar10/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
chkpts_dir="chkpts/cifar10/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
results_dir="results/cifar10/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
