...
rm -rf data/cifar100/all_clients_data

python data/cifar100/generate_data.py \
    --n_tasks 200 \
...
logs_dir="logs/cifar100/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
chkpts_dir="chkpts/cifar100/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
results_dir="results/cifar100/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
