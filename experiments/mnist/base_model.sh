...
rm -rf data/mnist/all_clients_data

python data/mnist/generate_data.py \
    --n_tasks 200 \
...
logs_dir="logs/mnist/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
chkpts_dir="chkpts/mnist/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
results_dir="results/mnist/${split_method}/alpha-${alpha}/fedavg_linear/${current_time}/"
