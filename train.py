...
def init_clients(args_, data_dir, logs_dir, chkpts_dir):
    ...
    train_iterators, val_iterators, test_iterators = \
        get_loaders(
            ...
            aggregator_=args_.aggregator_type, #added argument to accommodate embedding databases as input in non-parametric mode (parametric mode such as FedAvg requires raw image datasets as input)
            data_dir=data_dir,
            batch_size=args_.bz,
